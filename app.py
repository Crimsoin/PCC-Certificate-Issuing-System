...
@app.route("/")
def home():
    EMAIL_PASSWORD = os.getenv("EMAIL_PASSWORD")  # Load the email address from environment variables
    return render_template("index.html", email_password=EMAIL_PASSWORD)
